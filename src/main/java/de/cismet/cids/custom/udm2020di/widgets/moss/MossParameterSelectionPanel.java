...
public class MossParameterSelectionPanel extends javax.swing.JPanel implements ItemListener {
    ...
    private javax.swing.JRadioButton rbtnXls;
     ...
     */
    public MossParameterSelectionPanel(final boolean narrowLayout) {
        this();
    ...
    private void initComponents() {
        ...
        rbtnXls = new javax.swing.JRadioButton();
                ...
                javax.swing.BorderFactory.createCompoundBorder(
                    javax.swing.BorderFactory.createTitledBorder(
                        org.openide.util.NbBundle.getMessage(
                            ...
                            "MossParameterSelectionPanel.border.insideBorder.outsideBorder.title")),
        ...
        btnExport.setText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.btnExport.text"));          // NOI18N
        btnExport.setActionCommand(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.btnExport.actionCommand")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.btnReset.text"));          // NOI18N
        btnReset.setActionCommand(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.btnReset.actionCommand")); // NOI18N
        ...
        btnSelectAll.setText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.btnSelectAll.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.jLabel1.text")); // NOI18N
        ...
        rbtnCsv.setText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.rbtnCsv.text"));        // NOI18N
        rbtnCsv.setToolTipText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.rbtnCsv.toolTipText")); // NOI18N
        ...
        rbtnXlsx.setText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.rbtnXlsx.text"));        // NOI18N
        rbtnXlsx.setToolTipText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.rbtnXlsx.toolTipText")); // NOI18N
        ...
        rbtnShp.setText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.rbtnShp.text"));        // NOI18N
        rbtnShp.setToolTipText(org.openide.util.NbBundle.getMessage(
                MossParameterSelectionPanel.class,
                "MossParameterSelectionPanel.rbtnShp.toolTipText")); // NOI18N
    ...
    public final void setParameters(final Collection<Parameter> parameters) {
        ...
        final Runnable r = new Runnable() {
                ...
                @Override
                public void run() {
                    MossParameterSelectionPanel.this.selectionPanel.removeAll();
                    bindingGroup.unbind();
                    if ((parameters != null) && !MossParameterSelectionPanel.this.parameters.isEmpty()) {
                        for (final Parameter parameter : MossParameterSelectionPanel.this.parameters) {
                            final JCheckBox checkBox = new JCheckBox(parameter.getParameterName());
                            checkBox.addItemListener(WeakListeners.create(
                                    ItemListener.class,
                                    MossParameterSelectionPanel.this,
                                    checkBox));
                            MossParameterSelectionPanel.this.selectionPanel.add(checkBox);
